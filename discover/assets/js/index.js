...
$.ajax({
  ...
  method:"GET"
   ...
   document.getElementById("add0").addEventListener("click", postChat1);
    function postChat1(e) {
      e.preventDefault();
      const timestamp = Date.now();
      const chatTxt = document.getElementById("input0");
   ...
   document.getElementById("add1").addEventListener("click", postChat2);
   ...
   document.getElementById("add2").addEventListener("click", postChat3);
   ...
   fetchChat3.on("child_added", function (snapshot) {
    ...
    document.getElementById("add3").addEventListener("click", postChat4);
   ...
   fetchChat4.on("child_added", function (snapshot) {
    ...
    document.getElementById("add4").addEventListener("click", postChat5);
